...
```bash
curl -sSL https://raw.githubusercontent.com/biubiubiu125/sub2api/main/deploy/install.sh | sudo bash
```
...
# 卸载
curl -sSL https://raw.githubusercontent.com/biubiubiu125/sub2api/main/deploy/install.sh | sudo bash -s -- uninstall -y
```
...
# 下载并运行部署准备脚本
curl -sSL https://raw.githubusercontent.com/biubiubiu125/sub2api/main/deploy/docker-deploy.sh | bash
