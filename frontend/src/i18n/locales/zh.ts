export default {
  ...
  nav: {
    ...
    redeem: '兑换',
    referralCenter: '推广中心',
    referralCommissions: '佣金明细',
    referralWithdraw: '提现申请',
    referralWithdrawals: '提现记录',
    referralManagement: '推广分佣',
    referralSettings: '分佣设置',
    referralPending: '待审核推广员',
    referralAffiliates: '推广员管理',
    referralCommissionLedger: '佣金流水',
    referralWithdrawalReview: '提现审核',
    profile: '个人资料',
    users: '用户管理',
    groups: '分组管理',
    channels: '渠道管理',
  ...
  admin: {
    ...
    settings: {
      ...
      features: {
        ...
        riskControl: {
          title: '风控中心',
          description: '启用风控中心入口，用于配置内容审计、查看审核记录和运行状态。默认关闭。',
          configureLink: '前往 风控中心 配置内容审计策略',
          enabled: '启用风控中心',
          enabledHint: '关闭后管理员侧边栏隐藏该入口，直接访问路由也会被重定向。',
        },
      },
