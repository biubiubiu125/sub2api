export default {
  ...
  nav: {
    ...
    referralCommissions: 'Commission Details',
    referralWithdraw: 'Withdraw Application',
    referralWithdrawals: 'Withdrawal Records',
    referralManagement: 'Referral Management',
    referralSettings: 'Referral Settings',
    referralPending: 'Pending Affiliates',
    referralAffiliates: 'Affiliates',
    referralCommissionLedger: 'Commission Ledger',
    referralWithdrawalReview: 'Withdrawal Review',
    profile: 'Profile',
    users: 'Users',
    groups: 'Groups',
    channels: 'Channels',
  ...
  auth: {
    ...
    referralCodeInvalid: 'This referral link is invalid or no longer available. You can still register without it.',
  ...
  admin: {
    ...
    settings: {
      ...
      features: {
        ...
        riskControl: {
          title: 'Risk Control',
          description: 'Enable the risk-control entry for configuring content moderation, reviewing audit logs, and checking runtime status. Disabled by default.',
          configureLink: 'Open Risk Control to configure moderation policies',
          enabled: 'Enable Risk Control',
          enabledHint: 'When off, the admin sidebar entry is hidden and direct route access is redirected.',
        },
      },
