...
// ProvidePaymentService creates PaymentService and attaches fork referral plus notification email delivery.
func ProvidePaymentService(entClient *dbent.Client, registry *payment.Registry, loadBalancer payment.LoadBalancer, redeemService *RedeemService, subscriptionSvc *SubscriptionService, configService *PaymentConfigService, userRepo UserRepository, groupRepo GroupRepository, affiliateService *AffiliateService, customReferralService *CustomReferralService, notificationEmailService *NotificationEmailService) *PaymentService {
