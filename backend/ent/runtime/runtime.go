...
func init() {
	...
	// paymentorderDescCommissionBaseAmount is the schema descriptor for commission_base_amount field.
	paymentorderDescCommissionBaseAmount := paymentorderFields[7].Descriptor()
	// paymentorder.DefaultCommissionBaseAmount holds the default value on creation for the commission_base_amount field.
	paymentorder.DefaultCommissionBaseAmount = paymentorderDescCommissionBaseAmount.Default.(float64)
	// paymentorderDescCustomReferralRate is the schema descriptor for custom_referral_rate field.
	paymentorderDescCustomReferralRate := paymentorderFields[9].Descriptor()
	// paymentorder.DefaultCustomReferralRate holds the default value on creation for the custom_referral_rate field.
	paymentorder.DefaultCustomReferralRate = paymentorderDescCustomReferralRate.Default.(float64)
	// paymentorderDescCustomReferralCommissionStatus is the schema descriptor for custom_referral_commission_status field.
	paymentorderDescCustomReferralCommissionStatus := paymentorderFields[10].Descriptor()
	// paymentorder.DefaultCustomReferralCommissionStatus holds the default value on creation for the custom_referral_commission_status field.
	paymentorder.DefaultCustomReferralCommissionStatus = paymentorderDescCustomReferralCommissionStatus.Default.(string)
	// paymentorder.CustomReferralCommissionStatusValidator is a validator for the "custom_referral_commission_status" field. It is called by the builders before save.
	paymentorder.CustomReferralCommissionStatusValidator = paymentorderDescCustomReferralCommissionStatus.Validators[0].(func(string) error)
